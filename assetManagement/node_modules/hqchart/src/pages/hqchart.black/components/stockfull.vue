    ...
    <div id="stockfull" ref='stockfull' style="width:100%;height:100%">
        ...
        <div class='divstockmain' ref='divstockmain'>
            ...
            <div ref='divstockkline' style="height:200px;position: relative">
                <StockKLine ref='stockkline' :KlineType="KlineType" :DefaultSymbol=this.DefaultSymbol :DefaultPeriod=this.DefaultPeriod :TradeInfoTabWidth=this.TradeInfo.Width 
            ...
            <div class='divtradeinfo' ref='divtradeinfo' style='width:200px;position: relative' v-show="TradeInfo.IsShow">
                <StockTradeInfo ref='tradeinfo'  IsShareStock=1 :DefaultSymbol=this.DefaultSymbol >
                    
                    <!--  股票最新信息 !-->
                    <div ref='divstockinfo' name="info">
...
import StockTradeInfo from './stocktradeinfo.vue'
import StockKLine from './stockkline.demo.vue'
...
export default 
{
    ...
    created:function()
    {
        console.log(this.DefaultSymbol)
